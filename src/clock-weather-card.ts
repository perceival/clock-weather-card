...
@state() private showClock = true;
  ...
  private renderToday (): TemplateResult {
    ...
    const showApparent = this.config.apparent_sensor && this.config.displayed_temperature !== "apparent";
    const showOutdoor =  this.config.outdoor_temp_sensor && this.config.displayed_temperature !== "outdoor";
