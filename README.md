...
| cycle_display		| number           | **Optional** | 0 disables cycling, otherwise specifies seconds for cycling
| displayed_temperature	| string           | **Optional** | Which sensor to show on the cycling screen: current, apparent or outdoor
